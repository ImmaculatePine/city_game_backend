defmodule CityGameBackend.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: CityGameBackend.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    CityGameBackendWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
